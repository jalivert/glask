...
parse'cases =
  ...
  , ("classes-qualified-layout", ex "classes/qualified.layout.glask", pg "classes-qualified-layout")
  , ("classes-super-layout", ex "classes/super.layout.glask", pg "classes-super-layout")
  , ("data-bool-layout", ex "data/bool.layout.glask", pg "data-bool-layout")
  , ("data-phantom-layout", ex "data/phantom.layout.glask", pg "data-phantom-layout")
  , ("data-records-layout", ex "data/records.layout.glask", pg "data-records-layout")
  , ("evaluate-arith-layout", ex "evaluate/arith.layout.glask", pg "evaluate-arith-layout")
  , ("evaluate-lazy-layout", ex "evaluate/lazy.layout.glask", pg "evaluate-lazy-layout")
  , ("evaluate-matching-layout", ex "evaluate/matching.layout.glask", pg "evaluate-matching-layout")
  , ("higherkinded-higherkinded-layout", ex "higher-kinded/higherkinded.layout.glask", pg "higherkinded-higherkinded-layout")
  , ("higherkinded-lists-layout", ex "higher-kinded/lists.layout.glask", pg "higherkinded-lists-layout")
  , ("higherrank-basic-layout", ex "higher-rank/basic.layout.glask", pg "higherrank-basic-layout")
  , ("higherrank-case-layout", ex "higher-rank/case.layout.glask", pg "higherrank-case-layout")
  , ("higherrank-data-layout", ex "higher-rank/data.layout.glask", pg "higherrank-data-layout")
  , ("operators-implicit-layout", ex "operators/implicit.layout.glask", pg "operators-implicit-layout")
  , ("operators-infix-layout", ex "operators/infix.layout.glask", pg "operators-infix-layout")
  , ("operators-prefix-layout", ex "operators/prefix.layout.glask", pg "operators-prefix-layout")
  , ("operators-prefix-postfix-layout", ex "operators/prefix-postfix.layout.glask", pg "operators-prefix-postfix-layout")
